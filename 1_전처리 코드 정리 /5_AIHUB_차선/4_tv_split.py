...
# 저장 경로 선정
save_path = "E:/차선-횡단보도 인지 영상(수도권)/Validation"
...
# 예제 폴더 경로
folder_path = "E:/차선-횡단보도 인지 영상(수도권)/Validation/img"
# 파일 목록을 8:2로 랜덤하게 나눔
...
train_val_split_json("E:/차선-횡단보도 인지 영상(수도권)/Validation/input.json") # json 있는 경로
print("완료")